...
public class Volcanologist extends  BaseEntity{
    ...
    private Volcano observeVolcanoes;
    ...
    public Volcano getObserveVolcanoes() {
        return observeVolcanoes;
    }

    public void setObserveVolcanoes(Volcano observeVolcanoes) {
        this.observeVolcanoes = observeVolcanoes;
    }
}
